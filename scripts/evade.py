...
def evade(own_pose, target_pose, target_vel, maxlin, maxang, extrapolation_time=None):
	...
	return flee(relative_translation, maxlin, maxang)
...
def main():
	...
	while not rospy.is_shutdown():
		...
		if CONSTANT_TIME_EXTRAPOLATION:
			cmd = evade(own_pose, target_pose, target_vel, MAX_LIN, MAX_ANG, extrapolation_time=EXTRAPOLATION_TIME)
		else:
			cmd = evade(own_pose, target_pose, target_vel, MAX_LIN, MAX_ANG) # dynamically determine extrapolation time
